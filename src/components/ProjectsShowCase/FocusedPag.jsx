  ...
  return (
    ...
    >
      ...
      <div className={`flex gap-10 items-center justify-center`}>
        <button
          className={`text-secondary flex justify-center items-center h-28 w-28 text-4xl rounded-full border-[5px] border-secondary ${curImgIndex !== 0 ? "hover:bg-primary hover:text-black hover:border-primary" : "opacity-50"}`}
        ...
        <img
          src={curPj.img.src}
          alt={curPj.name}
          className={`lg:w-[600px] lg:h-[600px] object-cover unBlur`}
          key={Math.random()}
        />
        <button
          className={`text-secondary flex justify-center items-center h-28 w-28 text-4xl rounded-full border-[5px] border-secondary ${curImgIndex !== curCategoryPjs.length - 1 ? "hover:bg-primary hover:text-black hover:border-primary" : "opacity-50"}`}
